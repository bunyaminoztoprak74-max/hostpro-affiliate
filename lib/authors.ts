...
export const AUTHORS: Author[] = [
  ...
  },
  {
    ...
    bio: 'Sarah has been building, optimizing, and managing WordPress sites professionally for over 8 years. She started her career as a freelance WordPress developer, building sites for small businesses across the UK, before transitioning to content strategy and technical writing focused on web hosting and WordPress performance. Sarah specializes in managed WordPress hosting, WooCommerce performance optimization, and security hardening for production sites. She has migrated dozens of client sites between hosting providers and maintains her own test environment with active WordPress installations across five different hosts for ongoing benchmark comparisons. Sarah reviews all technical content on HostPro Reviews for accuracy, tests tutorial steps on live installations, and writes our in-depth WordPress guides. She personally verifies every pricing table and FAQ answer against the live provider checkout page before publication. Last content audit: August 2026.',
